...
<<<<<<<< HEAD:packages/room-server/src/database/ot/services/ot.service.spec.ts
import { IRoomChannelMessage } from '../interfaces/ot.interface';
========
import { IRoomChannelMessage } from '../../interfaces/ot.interface';
>>>>>>>> remote/develop:packages/room-server/src/database/ot/services/__tests__/ot.service.spec.ts
